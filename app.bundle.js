...
$__System.registerDynamic("a", [], true, function(require, exports, module) {
  ...
  (function() {
    'use strict';
    angular.module('angular-inview', []).directive('inView', ['$parse', inViewDirective]).directive('inViewContainer', inViewContainerDirective);
    function inViewDirective($parse) {
      return {
        ...
        link: function inViewDirectiveLink(scope, element, attrs, container) {
          ...
          var viewportEventSignal = signalSingle({type: 'initial'}).merge(signalFromEvent(window, 'scroll resize'));
          if (container) {
          ...
          var inviewInfoSignal = viewportEventSignal.map(function(event) {
            var viewportRect;
            if (container) {
            ...
            newInfo.changed = newInfo.inView !== lastInfo.inView || !angular.equals(newInfo.parts, lastInfo.parts) || !angular.equals(newInfo.direction, lastInfo.direction);
            return newInfo;
...
$__System.register('16', ['12', '15', 'c'], function (_export) {
    ...
    return {
        ...
        execute: function () {
            ...
            OdometerDirective = function OdometerDirective() {
                return {
            ...
            OdometerController = (function () {
                function OdometerController($element) {
                    _classCallCheck(this, OdometerController);
                ...
                _createClass(OdometerController, [{
                    key: 'startOdometer',
                    value: function startOdometer($index, $inview, $inviewpart, $event) {
            ...
            _export('default', OdometerDirective);
        }
    };
});
        ...
        execute: function () {
            ...
            SVGEl = (function () {
                function SVGEl(el) {
                    ...
                    this.paths.forEach(function (path, i) {
                        _this.pathsArr[i] = path;
                        path.style.strokeDasharray = _this.lengthsArr[i] = path.getTotalLength();
                    });
                    // undraw stroke
                    this.draw(0);
                }
            ...
            ProgressButton = (function () {
                ...
                _createClass(ProgressButton, [{
                    key: 'onButtonTransitionEnd',
                    value: function onButtonTransitionEnd(event) {
                        var _this3 = this;
                        ...
                        var interval = setInterval(function () {
                            ...
                            _this3.setProgress(progress);

                            if (progress === 1) {
                                clearInterval(interval);
                                _this3.finishLoading(1);
                                _this3.searchInProgressEl.className = _this3.searchInProgressEl.className.replace(/ng-enter-active/, 'ng-leave-active');
                                _this3.$timeout(function () {
                                    _this3.$state.go('journey');
                                }, 1000);
                            }
                        }, 100);
                    }
                    ...
                    key: 'finishLoading',
                    value: function finishLoading(status) {
...
$__System.register('26', ['25'], function (_export) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('default', ProgressButtonDirective);
        }
    };
});
